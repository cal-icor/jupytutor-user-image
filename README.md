# jupytutor-user-image

This is a Jupyter user image built on the Cal-ICOR `base-user-image` template,
extended with [jupytutor](https://github.com/kevyg03/jupytutor), a JupyterLab
extension that gives students LLM feedback based on autograder results and
course context.

See this repository's [CONTRIBUTING.md](https://github.com/cal-icor/jupytutor-user-image/blob/main/CONTRIBUTING.md) for instructions.
